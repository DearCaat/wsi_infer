...
def encoder_factory(model_name: str, pretrained: bool = True, freeze: bool = True, **kwargs) -> torch.nn.Module:
        ...
        elif 'gfy_abmil' in model_name:
            enc = GFYABMILSlideEncoder
...
class GFYABMILSlideEncoder(BaseSlideEncoder):

    def __init__(self, **build_kwargs):
        """
        GFYABMIL initialization.
        """
    ...
    def _build(self, pretrained=True):
        ...
        """
        self.enc_name = 'gfy_abmil'
        from trident.slide_encoder_models.model_zoo.reusable_blocks.ABMIL import GFYABMIL
...
class TitanSlideEncoder(BaseSlideEncoder):
    ...
    def _build(self, pretrained=True):
        ...
        model_path = get_weights_path('slide', self.enc_name)
